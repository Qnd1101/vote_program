...
select me.m_no, me.m_name, pa.p_name, 
		case when me.p_school = '1' then '고졸'
			when me.p_school = '2' then '학사'
			when me.p_school = '3' then '석사'
			else '박사' end as p_school 
		, me.m_jumin, me.m_city, pa.p_tel1 || '-' || pa.p_tel2 || '-' || pa.p_tel3 as p_tel
from TBL_VOTE_202005 vo, tbl_member_202005 me, tbl_party_202005 pa
where me.m_no = vo.m_no and pa.p_code = me.p_code
group by me.m_no, me.m_name, pa.p_name, me.p_school,me.m_jumin, me.m_city,pa.p_tel1, pa.p_tel2, pa.p_tel3;